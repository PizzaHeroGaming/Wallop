...
import { camera, renderer, isMobile, isSteamBuild, tryEnterFullscreen } from './renderer.js?v=4af10e4';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=4af10e4';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=4af10e4';
import { gameState, cam } from './state.js?v=4af10e4';
import { Audio } from './audio.js?v=4af10e4';
import * as Steam from './steam.js?v=4af10e4';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=4af10e4';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=4af10e4';
import { tmp, tmp2 } from './utils.js?v=4af10e4';
