...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=b20c8b7';
...
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=b20c8b7';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=b20c8b7';
import { tmp, tmp2 } from './utils.js?v=b20c8b7';
