...
import { camera, renderer, isMobile, isSteamBuild, tryEnterFullscreen, applyGraphicsQuality } from './renderer.js?v=4d39b32';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=4d39b32';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=4d39b32';
import { gameState, cam } from './state.js?v=4d39b32';
import * as Review from './review.js?v=4d39b32';
import { Audio } from './audio.js?v=4d39b32';
import * as Steam from './steam.js?v=4d39b32';
import * as PGS from './pgs.js?v=4d39b32'; // native Play Games UIs (achievements/leaderboard views)
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=4d39b32';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=4d39b32';
import { Cloud } from './cloud.js?v=4d39b32';
import { tmp, tmp2 } from './utils.js?v=4d39b32';
...
const GameAds = (function () {
  ...
  function showRewarded(cb) {
    // The OS pauses our music while a fullscreen ad is up. Resume it on
    // completion (a user-gesture context, so play() is allowed) — no-ops if no
    // track is queued, e.g. the game-over double-slices ad after stopMusic().
    const done = (success) => { Audio.resumeMusic(); if (cb) cb(!!success); };
