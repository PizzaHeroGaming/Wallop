...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=1186fed';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=1186fed';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=1186fed';
import { gameState, cam } from './state.js?v=1186fed';
import { Audio } from './audio.js?v=1186fed';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=1186fed';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=1186fed';
import { tmp, tmp2 } from './utils.js?v=1186fed';
