...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=2c06d16';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=2c06d16';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=2c06d16';
import { gameState, cam } from './state.js?v=2c06d16';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=2c06d16';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=2c06d16';
import { tmp, tmp2 } from './utils.js?v=2c06d16';
