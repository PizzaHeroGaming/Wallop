...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=d2c85ad';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=d2c85ad';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=d2c85ad';
import { gameState, cam } from './state.js?v=d2c85ad';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=d2c85ad';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=d2c85ad';
import { tmp, tmp2 } from './utils.js?v=d2c85ad';
