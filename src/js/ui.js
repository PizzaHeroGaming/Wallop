...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=47afa89';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=47afa89';
...
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=47afa89';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=47afa89';
import { tmp, tmp2 } from './utils.js?v=47afa89';
