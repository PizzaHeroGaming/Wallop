...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=bdc6c4c';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=bdc6c4c';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=bdc6c4c';
import { gameState, cam } from './state.js?v=bdc6c4c';
import { Audio } from './audio.js?v=bdc6c4c';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=bdc6c4c';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=bdc6c4c';
import { tmp, tmp2 } from './utils.js?v=bdc6c4c';
