...
import { camera, renderer, isMobile, isSteamBuild, tryEnterFullscreen } from './renderer.js?v=5165ee8';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=5165ee8';
...
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=5165ee8';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=5165ee8';
import { tmp, tmp2 } from './utils.js?v=5165ee8';
