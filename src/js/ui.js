...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=7313bad';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=7313bad';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=7313bad';
import { gameState, cam } from './state.js?v=7313bad';
import { Audio } from './audio.js?v=7313bad';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=7313bad';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=7313bad';
import { tmp, tmp2 } from './utils.js?v=7313bad';
