...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=b71b3e6';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=b71b3e6';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=b71b3e6';
import { gameState, cam } from './state.js?v=b71b3e6';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=b71b3e6';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=b71b3e6';
import { tmp, tmp2 } from './utils.js?v=b71b3e6';
