...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=4d7ddbc';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=4d7ddbc';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=4d7ddbc';
import { gameState, cam } from './state.js?v=4d7ddbc';
import { Audio } from './audio.js?v=4d7ddbc';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=4d7ddbc';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=4d7ddbc';
import { tmp, tmp2 } from './utils.js?v=4d7ddbc';
