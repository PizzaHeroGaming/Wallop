...
import { camera, renderer, isMobile, tryEnterFullscreen } from './renderer.js?v=3f9bb04';
import {
  player, enemies,
...
import { WEAPONS, ARMOR, TOMES, rebuildOrbits } from './weapons.js?v=3f9bb04';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=3f9bb04';
import { gameState, cam } from './state.js?v=3f9bb04';
import { Audio } from './audio.js?v=3f9bb04';
import { CFG, RARITY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=3f9bb04';
...
import { Profile, CATALOG, ARENAS, CHALLENGES } from './profile.js?v=3f9bb04';
import { tmp, tmp2 } from './utils.js?v=3f9bb04';
