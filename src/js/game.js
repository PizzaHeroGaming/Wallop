...
import { scene, camera, renderer, composer, sun, clock, isMobile, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=1c8e38a';
import {
  player,
...
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=1c8e38a';
import {
  gameState, cam,
} from './state.js?v=1c8e38a';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=1c8e38a';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=1c8e38a';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=1c8e38a';
import { setWorldArena } from './world.js?v=1c8e38a';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=1c8e38a';
import {
