...
import { scene, camera, renderer, composer, sun, clock, isMobile, isSteamBuild, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=c4c734c';
import {
  player,
...
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=c4c734c';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=c4c734c';
import {
  gameState, cam,
} from './state.js?v=c4c734c';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=c4c734c';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=c4c734c';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=c4c734c';
import { setWorldArena } from './world.js?v=c4c734c';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=c4c734c';
