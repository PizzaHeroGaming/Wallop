...
import { scene, camera, renderer, composer, sun, clock, isMobile, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=e4d3e36';
import {
  player,
...
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=e4d3e36';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=e4d3e36';
import {
  gameState, cam,
} from './state.js?v=e4d3e36';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=e4d3e36';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=e4d3e36';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=e4d3e36';
import { setWorldArena } from './world.js?v=e4d3e36';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=e4d3e36';
