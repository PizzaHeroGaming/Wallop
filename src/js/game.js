...
import { scene, camera, renderer, composer, sun, clock, isMobile, isSteamBuild, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=2d8ee53';
import {
  player,
...
} from './entities.js?v=2d8ee53';
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=2d8ee53';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=2d8ee53';
import {
  gameState, cam,
} from './state.js?v=2d8ee53';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=2d8ee53';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=2d8ee53';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=2d8ee53';
...
import {
  ...
  initUI,
  addCameraShake,
} from './ui.js?v=2d8ee53';
import { Settings } from './settings.js?v=2d8ee53';
