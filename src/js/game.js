...
import { scene, camera, renderer, composer, sun, clock, isMobile, isSteamBuild, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=4d7ddbc';
import {
  player,
...
} from './entities.js?v=4d7ddbc';
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=4d7ddbc';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=4d7ddbc';
import {
  gameState, cam,
} from './state.js?v=4d7ddbc';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=4d7ddbc';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=4d7ddbc';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=4d7ddbc';
import { setWorldArena } from './world.js?v=4d7ddbc';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=4d7ddbc';
import { Audio } from './audio.js?v=4d7ddbc';
import {
