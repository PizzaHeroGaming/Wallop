...
import { scene, camera, renderer, composer, sun, clock, isMobile, isSteamBuild, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=c8d6522';
import {
  player,
...
} from './entities.js?v=c8d6522';
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=c8d6522';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=c8d6522';
import {
  gameState, cam,
} from './state.js?v=c8d6522';
import { CFG, STAGE_MULTS, DIFFICULTIES, ENDLESS, stageMults } from './config.js?v=c8d6522';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=c8d6522';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=c8d6522';
import { setWorldArena } from './world.js?v=c8d6522';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=c8d6522';
import { Audio } from './audio.js?v=c8d6522';
import * as Steam from './steam.js?v=c8d6522';
import { checkForUpdate } from './versionCheck.js?v=c8d6522';
import {
  ...
  initUI,
  addCameraShake,
} from './ui.js?v=c8d6522';
import { Settings } from './settings.js?v=c8d6522';
