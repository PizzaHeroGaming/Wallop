...
import { scene, camera, renderer, composer, sun, clock, isMobile, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=3721c50';
import {
  player,
...
} from './entities.js?v=3721c50';
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=3721c50';
import {
  gameState, cam,
} from './state.js?v=3721c50';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=3721c50';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=3721c50';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=3721c50';
import { setWorldArena } from './world.js?v=3721c50';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=3721c50';
import {
