...
import { scene, camera, renderer, composer, sun, clock, isMobile, tryEnterFullscreen, releasePtLight, setRendererArena } from './renderer.js?v=aceb222';
import {
  player,
...
import { WEAPONS, ARMOR, TOMES, setDamageEnemyForWeapons, rebuildOrbits } from './weapons.js?v=aceb222';
import { STAT_UPGRADES, SYNERGY_UPGRADES } from './upgrades.js?v=aceb222';
import {
  gameState, cam,
} from './state.js?v=aceb222';
import { CFG, STAGE_MULTS, DIFFICULTIES } from './config.js?v=aceb222';
import { Profile, ARENAS, CHALLENGES } from './profile.js?v=aceb222';
import { groundHeight, resolveSolids, setTerrainArena } from './terrain.js?v=aceb222';
import { setWorldArena } from './world.js?v=aceb222';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong } from './utils.js?v=aceb222';
