...
import { scene } from './renderer.js?v=56e3d9b';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=56e3d9b';
import { ARENAS } from './profile.js?v=56e3d9b';
import { killMesh } from './utils.js?v=56e3d9b';
