import { CFG, IS_MOBILE_EARLY } from './config.js?v=7a418d1';
import { scene } from './renderer.js?v=7a418d1';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=7a418d1';
import { ARENAS } from './profile.js?v=7a418d1';
import { killMesh } from './utils.js?v=7a418d1';
