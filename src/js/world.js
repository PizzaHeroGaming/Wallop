...
import { scene } from './renderer.js?v=5ec5aef';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=5ec5aef';
import { ARENAS } from './profile.js?v=5ec5aef';
import { killMesh } from './utils.js?v=5ec5aef';
