...
import { scene } from './renderer.js?v=01a2de7';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=01a2de7';
import { ARENAS } from './profile.js?v=01a2de7';
import { killMesh } from './utils.js?v=01a2de7';
