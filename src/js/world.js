import { CFG, IS_MOBILE_EARLY } from './config.js?v=8cdf354';
import { scene } from './renderer.js?v=8cdf354';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=8cdf354';
import { ARENAS } from './profile.js?v=8cdf354';
import { killMesh } from './utils.js?v=8cdf354';
