import { CFG, IS_MOBILE_EARLY } from './config.js?v=4f55cd0';
import { scene } from './renderer.js?v=4f55cd0';
import { groundHeight, addSolid, obstacles, solidProps } from './terrain.js?v=4f55cd0';
import { ARENAS } from './profile.js?v=4f55cd0';
import { killMesh } from './utils.js?v=4f55cd0';
