...
import { isSteamBuild } from './renderer.js?v=41ed89f';
import { Profile, CATALOG } from './profile.js?v=41ed89f';
import * as PGS from './pgs.js?v=41ed89f'; // Play Games (mobile) — same triggers, second backend
