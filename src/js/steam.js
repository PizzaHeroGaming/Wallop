...
import { isSteamBuild } from './renderer.js?v=ae0ffca';
import { Profile, CATALOG } from './profile.js?v=ae0ffca';
import * as PGS from './pgs.js?v=ae0ffca'; // Play Games (mobile) — same triggers, second backend
