...
import { isSteamBuild } from './renderer.js?v=2299eb5';
import { Profile, CATALOG } from './profile.js?v=2299eb5';
import * as PGS from './pgs.js?v=2299eb5'; // Play Games (mobile) — same triggers, second backend
