...
import { isSteamBuild } from './renderer.js?v=46671df';
import { Profile, CATALOG } from './profile.js?v=46671df';
import * as PGS from './pgs.js?v=46671df'; // Play Games (mobile) — same triggers, second backend
