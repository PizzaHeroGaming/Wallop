...
import { isSteamBuild } from './renderer.js?v=1e5de5f';
import { Profile, CATALOG } from './profile.js?v=1e5de5f';
import * as PGS from './pgs.js?v=1e5de5f'; // Play Games (mobile) — same triggers, second backend
