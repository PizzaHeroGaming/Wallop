...
import { isSteamBuild } from './renderer.js?v=4d39b32';
import { Profile, CATALOG } from './profile.js?v=4d39b32';
import * as PGS from './pgs.js?v=4d39b32'; // Play Games (mobile) — same triggers, second backend
