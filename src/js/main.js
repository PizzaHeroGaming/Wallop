...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=1c8e38a';
import { gameState } from './state.js?v=1c8e38a';
import { initGame, update } from './game.js?v=1c8e38a';
import './world.js?v=1c8e38a'; // side-effect only: builds terrain scenery at load time
