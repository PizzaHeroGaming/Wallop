...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=0646da5';
import { gameState } from './state.js?v=0646da5';
import { initGame, update } from './game.js?v=0646da5';
import './world.js?v=0646da5'; // side-effect only: builds terrain scenery at load time
