...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=47afa89';
import { gameState, cam } from './state.js?v=47afa89';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=47afa89';
import './world.js?v=47afa89'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=47afa89';
import { pollGamepad, applyOffer } from './ui.js?v=47afa89';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=47afa89';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=47afa89';
