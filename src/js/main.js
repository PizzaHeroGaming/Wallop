...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=faa3f9d';
import { gameState } from './state.js?v=faa3f9d';
import { initGame, update } from './game.js?v=faa3f9d';
import './world.js?v=faa3f9d'; // side-effect only: builds terrain scenery at load time
