...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=cfed536';
import { gameState } from './state.js?v=cfed536';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=cfed536';
import './world.js?v=cfed536'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=cfed536';
import { pollGamepad } from './ui.js?v=cfed536';
