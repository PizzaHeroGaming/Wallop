...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=35b8cd2';
import { gameState } from './state.js?v=35b8cd2';
import { initGame, update } from './game.js?v=35b8cd2';
import './world.js?v=35b8cd2'; // side-effect only: builds terrain scenery at load time
