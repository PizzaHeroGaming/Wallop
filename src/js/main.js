...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=a8c1fa5';
import { gameState, cam } from './state.js?v=a8c1fa5';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=a8c1fa5';
import './world.js?v=a8c1fa5'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=a8c1fa5';
import { pollGamepad, applyOffer } from './ui.js?v=a8c1fa5';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=a8c1fa5';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=a8c1fa5';
