...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=ea053d1';
import { gameState, cam } from './state.js?v=ea053d1';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=ea053d1';
import './world.js?v=ea053d1'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=ea053d1';
import { pollGamepad, applyOffer } from './ui.js?v=ea053d1';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=ea053d1';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=ea053d1';
