...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=5193e30';
import { gameState } from './state.js?v=5193e30';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=5193e30';
import './world.js?v=5193e30'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=5193e30';
import { pollGamepad } from './ui.js?v=5193e30';
