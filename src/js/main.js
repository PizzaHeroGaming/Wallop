...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=d8c572c';
import { gameState, cam } from './state.js?v=d8c572c';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=d8c572c';
import './world.js?v=d8c572c'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=d8c572c';
import { pollGamepad, applyOffer } from './ui.js?v=d8c572c';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=d8c572c';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=d8c572c';
