...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=fde18b9';
import { gameState } from './state.js?v=fde18b9';
import { initGame, update } from './game.js?v=fde18b9';
import './world.js?v=fde18b9'; // side-effect only: builds terrain scenery at load time
