...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=86b4455';
import { gameState } from './state.js?v=86b4455';
import { initGame, update, updateTitleScene } from './game.js?v=86b4455';
import './world.js?v=86b4455'; // side-effect only: builds terrain scenery at load time
