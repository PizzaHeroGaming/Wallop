...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=505baad';
import { gameState, cam } from './state.js?v=505baad';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=505baad';
import { updateArenaWalls } from './world.js?v=505baad'; // also builds terrain scenery + boundary walls at load (side-effect)
import { Settings } from './settings.js?v=505baad';
import { pollGamepad, applyOffer } from './ui.js?v=505baad';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=505baad';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=505baad';
