...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=a5d311a';
import { gameState } from './state.js?v=a5d311a';
import { initGame, update, updateTitleScene } from './game.js?v=a5d311a';
import './world.js?v=a5d311a'; // side-effect only: builds terrain scenery at load time
