...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=2cbd1e2';
import { gameState } from './state.js?v=2cbd1e2';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=2cbd1e2';
import './world.js?v=2cbd1e2'; // side-effect only: builds terrain scenery at load time
