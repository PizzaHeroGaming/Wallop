...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap, getQualityFpsCap, applyGraphicsQuality } from './renderer.js?v=4d39b32';
import { gameState, cam } from './state.js?v=4d39b32';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=4d39b32';
import { updateArenaWalls } from './world.js?v=4d39b32'; // also builds terrain scenery + boundary walls at load (side-effect)
import { Settings } from './settings.js?v=4d39b32';
import { pollGamepad, applyOffer } from './ui.js?v=4d39b32';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=4d39b32';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=4d39b32';
import { Cloud } from './cloud.js?v=4d39b32'; // Play Games cloud save (Android only; no-op elsewhere)
