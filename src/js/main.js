...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=1506af5';
import { gameState } from './state.js?v=1506af5';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=1506af5';
import './world.js?v=1506af5'; // side-effect only: builds terrain scenery at load time
