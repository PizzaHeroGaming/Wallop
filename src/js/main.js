...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=1e8bc6f';
import { gameState } from './state.js?v=1e8bc6f';
import { initGame, update } from './game.js?v=1e8bc6f';
import './world.js?v=1e8bc6f'; // side-effect only: builds terrain scenery at load time
