...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=f036d5b';
import { gameState } from './state.js?v=f036d5b';
import { initGame, update } from './game.js?v=f036d5b';
import './world.js?v=f036d5b'; // side-effect only: builds terrain scenery at load time
