...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=49ba77a';
import { gameState } from './state.js?v=49ba77a';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=49ba77a';
import './world.js?v=49ba77a'; // side-effect only: builds terrain scenery at load time
