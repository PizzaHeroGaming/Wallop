...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=e4d3e36';
import { gameState } from './state.js?v=e4d3e36';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=e4d3e36';
import './world.js?v=e4d3e36'; // side-effect only: builds terrain scenery at load time
