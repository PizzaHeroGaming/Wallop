...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=b84f739';
import { gameState, cam } from './state.js?v=b84f739';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=b84f739';
import './world.js?v=b84f739'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=b84f739';
import { pollGamepad, applyOffer } from './ui.js?v=b84f739';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=b84f739';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=b84f739';
