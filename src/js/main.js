...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=6779f72';
import { gameState } from './state.js?v=6779f72';
import { initGame, update, updateTitleScene, updateIntroSweep } from './game.js?v=6779f72';
import './world.js?v=6779f72'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=6779f72';
import { pollGamepad } from './ui.js?v=6779f72';
