...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=11a10e2';
import { gameState, cam } from './state.js?v=11a10e2';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=11a10e2';
import './world.js?v=11a10e2'; // side-effect only: builds terrain scenery at load time
import { Settings } from './settings.js?v=11a10e2';
import { pollGamepad, applyOffer } from './ui.js?v=11a10e2';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=11a10e2';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=11a10e2';
