...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=b72487d';
import { gameState } from './state.js?v=b72487d';
import { initGame, update } from './game.js?v=b72487d';
import './world.js?v=b72487d'; // side-effect only: builds terrain scenery at load time
