...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap } from './renderer.js?v=02bc490';
import { gameState } from './state.js?v=02bc490';
import { initGame, update } from './game.js?v=02bc490';
import './world.js?v=02bc490'; // side-effect only: builds terrain scenery at load time
