...
import { scene, camera, renderer, clock, composer, isMobile, tryEnterFullscreen, rearmFullscreenOnNextTap, getQualityFpsCap, applyGraphicsQuality } from './renderer.js?v=41ed89f';
import { gameState, cam } from './state.js?v=41ed89f';
import { initGame, update, updateTitleScene, updateIntroSweep, spawnBoss } from './game.js?v=41ed89f';
import { updateArenaWalls } from './world.js?v=41ed89f'; // also builds terrain scenery + boundary walls at load (side-effect)
import { Settings } from './settings.js?v=41ed89f';
import { pollGamepad, applyOffer } from './ui.js?v=41ed89f';
import { spawnEnemy, enemies, player, ENEMY_DEFS } from './entities.js?v=41ed89f';
import { WEAPONS, ARMOR, TOMES } from './weapons.js?v=41ed89f';
import { Cloud } from './cloud.js?v=41ed89f'; // Play Games cloud save (Android only; no-op elsewhere)
