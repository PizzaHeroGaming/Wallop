import { CFG, IS_MOBILE_EARLY, STAGE_MULTS, DIFFICULTIES, stageMults } from './config.js?v=c5ce52f';
import { scene, camera, isMobile, tryEnterFullscreen, renderer, acquirePtLight, releasePtLight, getParticleScale } from './renderer.js?v=c5ce52f';
import { groundHeight, addSolid, resolveSolids, solidProps } from './terrain.js?v=c5ce52f';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong, smoothPhong } from './utils.js?v=c5ce52f';
import { gameState } from './state.js?v=c5ce52f';
import { Profile } from './profile.js?v=c5ce52f';
