import { CFG, IS_MOBILE_EARLY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=a0a6eff';
import { scene, camera, isMobile, tryEnterFullscreen, renderer, acquirePtLight, releasePtLight } from './renderer.js?v=a0a6eff';
import { groundHeight, addSolid, resolveSolids, solidProps } from './terrain.js?v=a0a6eff';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong, smoothPhong } from './utils.js?v=a0a6eff';
import { gameState } from './state.js?v=a0a6eff';
import { Profile } from './profile.js?v=a0a6eff';
