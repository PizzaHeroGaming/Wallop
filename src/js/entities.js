import { CFG, IS_MOBILE_EARLY, STAGE_MULTS, DIFFICULTIES, stageMults } from './config.js?v=b81e1d0';
import { scene, camera, isMobile, tryEnterFullscreen, renderer, acquirePtLight, releasePtLight, getParticleScale } from './renderer.js?v=b81e1d0';
import { groundHeight, addSolid, resolveSolids, solidProps } from './terrain.js?v=b81e1d0';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong, smoothPhong } from './utils.js?v=b81e1d0';
import { gameState } from './state.js?v=b81e1d0';
import { Profile } from './profile.js?v=b81e1d0';
