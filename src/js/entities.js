import { CFG, IS_MOBILE_EARLY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=d2c85ad';
import { scene, camera, isMobile, tryEnterFullscreen, renderer, acquirePtLight, releasePtLight } from './renderer.js?v=d2c85ad';
import { groundHeight, addSolid, resolveSolids, solidProps } from './terrain.js?v=d2c85ad';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong, smoothPhong } from './utils.js?v=d2c85ad';
import { gameState } from './state.js?v=d2c85ad';
import { Profile } from './profile.js?v=d2c85ad';
