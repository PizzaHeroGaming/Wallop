import { CFG, IS_MOBILE_EARLY, STAGE_MULTS, DIFFICULTIES } from './config.js?v=be5e205';
import { scene, camera, isMobile, tryEnterFullscreen, renderer, acquirePtLight, releasePtLight } from './renderer.js?v=be5e205';
import { groundHeight, addSolid, resolveSolids, solidProps } from './terrain.js?v=be5e205';
import { killMesh, clamp, rand, tmp, tmp2, flatPhong, smoothPhong } from './utils.js?v=be5e205';
import { gameState } from './state.js?v=be5e205';
import { Profile } from './profile.js?v=be5e205';
